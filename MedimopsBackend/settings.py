"""
Django settings for MedimopsBackend project.
...
SECRET_KEY = 'django-insecure-%w#5*+p3ra4a3^3)o!k!b4_w-^evqlchnei8cu)gge3^7)kb18'
...
ROOT_URLCONF = 'MedimopsBackend.urls'
...
WSGI_APPLICATION = 'MedimopsBackend.wsgi.application'
